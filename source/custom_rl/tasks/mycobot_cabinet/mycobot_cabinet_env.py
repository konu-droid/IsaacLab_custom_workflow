...
@configclass
class MyCobotCabinetEnvCfg(DirectRLEnvCfg):
    # env
    ...
    # robot
    robot: ArticulationCfg = MYCOBOT_CFG.replace(prim_path="/World/envs/env_.*/Robot")
...
class MyCobotCabinetEnv(DirectRLEnv):
    ...
    cfg: MyCobotCabinetEnvCfg

    def __init__(self, cfg: MyCobotCabinetEnvCfg, render_mode: str | None = None, **kwargs):
